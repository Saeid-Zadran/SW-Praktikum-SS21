          ...
          <DialogContent>
            ...
            <form className={classes.root} noValidate autoComplete='off'>
              ...
              <TextField autoFocus type='text' required fullWidth margin='normal' id='degreeCourse' label='DegreeCourse:' value={degreeCourse}
                onChange={this.textFieldValueChange} error={degreeCourseValidationFailed}
                helperText={degreeCourseValidationFailed ? 'The degreeCourse must contain at least one character' : ' '} />
              <TextField type='text' required fullWidth margin='normal' id='preferences' label='Preferences:' value={preferences}
                onChange={this.textFieldValueChange} error={preferencesValidationFailed}
                helperText={preferencesValidationFailed ? 'The Preferences must contain at least one character' : ' '} />
              <TextField type='text' required fullWidth margin='normal' id='personId' label='PersonId:' value={personId}
                onChange={this.textFieldValueChange} error={personIdValidationFailed}
                helperText={personIdValidationFailed ? 'The PersonId must contain at least one character' : ' '} />
            </form>
