...
class ProfileDetails extends Component {
  ...
  getProfile = () => {
    AppApi.getApi()
      .getProfile(this.props.profileID)
      .then((profile) =>
        this.setState({
          profile: profile,
          loadingInProgress: false,
  ...
  render() {
    ...
    return (
      <Paper variant="outlined" className={classes.root}>
        ...
        {profile ? (
          <Typography>
            Profile: {profile.getName()}, {profile.getAge()},{" "}
            {profile.getAdress()}, {profile.getSemester()},{" "}
        ...
        <ContextErrorMessage
          error={loadingError}
          contextErrorMsg={`The data of profile id ${profileID} could not be loaded.`}
