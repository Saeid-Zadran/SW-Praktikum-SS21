...
class PersonMapper(Mapper):
    ...
    def update_google_user(self, person):
        ...
        command = "UPDATE person SET first_name=%s, last_name=%s, google_user_id=%s, google_mail=%s WHERE id=%s"
        data = (person.get_first_name(),person.get_last_name(), person.get_google_mail(), person.get_google_user_id(), person.get_id())
        cursor.execute(command, data)
